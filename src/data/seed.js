...
export const articlesSeed = [
    {
        ...
        <h3 class="font-display font-700 text-xl text-sol-200 mt-6 mb-3">Formule de calcul de l'énergie</h3>
        <p>Pour calculer la consommation énergétique quotidienne d'un appareil, on utilise la formule suivante :</p>
        $$\text{Énergie quotidienne (Wh)} = \text{Puissance de l'appareil (W)} \times \text{Heures d'utilisation par jour (h)}$$
        <p>Par exemple, un réfrigérateur de 150W fonctionnant 24h par jour consomme : $150 \times 24 = 3600$ Wh par jour.</p>
    ...
    },
    {
        ...
        <h3 class="font-display font-700 text-xl text-sol-200 mt-6 mb-3">Exemple de calcul en JavaScript</h3>
        <p>Voici un exemple de script pour calculer vos besoins :</p>
        <pre><code class="language-javascript">// Calcul de la consommation journalière
        function calculerConsommation(puissanceW, heures) {
            return puissanceW * heures; // Résultat en Wh
        }

        // Exemple : réfrigérateur 150W pendant 24h
        const consommation = calculerConsommation(150, 24);
        console.log(\`Consommation : \${consommation} Wh/jour\`);</code></pre>
